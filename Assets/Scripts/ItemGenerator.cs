...
public class ItemGenerator : MonoBehaviour
{
    ...
    public GameObject RollItem(Item.ItemType itemTypeOverride, Item.ItemRarity itemRarityOverride)
    {
        GameObject itemRolled = null;

        Item.ItemType itemType = itemTypeOverride;
        Item.ItemRarity itemRarity = itemRarityOverride;
